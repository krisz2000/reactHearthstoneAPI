...
export default function UpdateCard(props) {
  const [id, setId] = useState(props.card.cardId);
  ...
  const [attack, setAttack] = useState(props.card.attack);
  const [health, setHealth] = useState(props.card.health);
  const [durability, setDurability] = useState(props.card.durability);
  ...
  const handleUpdate = (event) => {
    ...
    if (props.onUpdate(props.card.cardId, card)) {
      history.push("/list/");
    } else {
